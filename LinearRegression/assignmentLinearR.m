...
price = beta(1) + beta(2) * 2 + beta(3) * 500 + beta(4) * 8; % You should change this
...
num_iters = 1000 % you should change this
...
price = beta(1) + beta(2) * ((2 - mu(1)) / sigma(1)) + beta(3) * ((500 - mu(2)) / sigma(2)) + beta(4) * ((8 - mu(3)) / sigma(3)); % You should change this
